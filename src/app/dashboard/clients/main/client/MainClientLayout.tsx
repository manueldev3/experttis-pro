...
const items: MenuItem[] = [
    getItem('Dashboard', Routes.clients.dashboard, <PieChartOutlined />),
    getItem('My Questions', Routes.clients.myQuestions, <QuestionCircleOutlined />),
    getItem('Profile', Routes.clients.profile, <UserOutlined />),
    getItem('Chat', Routes.clients.chat, <MessageOutlined />),
    getItem('Consultancies', Routes.clients.consultancies, <SnippetsOutlined />),
...
export default function MainClientLayout(props: MainLayoutProps) {
    ...
    useEffect(() => {
        /*  if (!loadingAuth && !currentUser) {
                router.push(Routes.clients.login);
         } */
                ...
                <Menu
                    ...
                    onClick={async ({ key }) => {
                        switch (key) {
                            case "logout":
                                await signOut(auth);
                                router.replace(Routes.clients.login);
                                break;
